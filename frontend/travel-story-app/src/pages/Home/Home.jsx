...
const filterStoriesByDate=async(day)=>{
  try{
    const startDate = day.from ? moment(day.from).toISOString() : null;
    const endDate = day.to ? moment(day.to).endOf("day").toISOString() : null;
...
//handle Date Range Search   
  ...
  return (
    <>
      <Navbar userInfo={userInfo} searchQuery={searchQuery} setSearchQuery={setSearchQuery} onSearchNote={onSearhStory} handleClearSearch={handleClearSearch}/>
        ...
        <div className="flex gap-7">
          <div className="flex-1  justify-center">
            {allStories.length>0?(
              ...
              <EmptyCard imgSrc={EmptyImg} message={`start creating your first Travel Story! Click the 'Add' button to jot down
      ...
      <Modal isOpen={openViewModal.isShown}
        ...
        className="model-box">
          ...
          onClose={()=>{setOpenViewModal((preState)=>({...preState,isShown:false}));
        }}
          onEditClick={()=>{setOpenViewModal((preState)=>({...preState,isShown:false}));
