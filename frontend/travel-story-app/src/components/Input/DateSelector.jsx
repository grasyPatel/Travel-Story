...
const DateSelector = ({date, setDate}) => {;
  ...
  return (
    <div>
       ...
       {openDatePicker && ( <div className=' p-5 bg-sky-50/80 rounded-lg relative pt-9'>
          <button className='w-10 h-10 flex rounded-full items-center justify-center bg-sky-100 hover:bg-sky-100 absolute top-2 right-2' onClick={()=>{
